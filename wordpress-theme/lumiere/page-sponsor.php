...
?>
<main id="top">
<section class="inner-hero inner-service"><div class="inner-hero-bg"><img src="<?php echo esc_url(lumiere_asset('event-02.jpg')); ?>" alt="光のパフォーマンスと観客"></div><div class="inner-hero-copy"><p class="breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>">HOME</a> / SPONSOR</p><p class="kicker">PARTNER WITH US</p><h1>応援を、<br>文化の力へ。</h1><p>企業・個人の皆さまと、若者の挑戦、地域のにぎわい、新しい文化の未来を育てます。</p></div><span class="inner-hero-number">07</span></section>
