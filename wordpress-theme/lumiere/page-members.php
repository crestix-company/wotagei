...
<section class="member-recruit" id="recruit"><article><p class="kicker">JOIN LUMIÈRE</p><h2>メンバー<br>募集中!!!</h2><p>技術だけでなく、文化を広げたい気持ちを大切にしています。出演、作品づくり、地域活動に一緒に挑戦したい方をお待ちしています。</p><a href="<?php echo esc_url(home_url('/contact/#contact-form')); ?>">メンバー応募を相談する <span>↗</span></a></article><article><p class="kicker">JOIN THE ASSOCIATION</p><h2>所属チーム<br>募集中</h2><p>一般社団法人ヲタ芸普及協会では、地域や活動歴を問わず、ともにヲタ芸の未来を育てるチームを募集しています。</p><a href="<?php echo esc_url(home_url('/contact/#contact-form')); ?>">所属チームについて相談する <span>↗</span></a></article></section>
