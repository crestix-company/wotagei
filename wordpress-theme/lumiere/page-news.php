...
?>
<main id="top">
<section class="inner-hero journal-hero news-hero"><div class="inner-hero-bg"><img src="<?php echo esc_url(lumiere_asset('news-hero-starry-team.jpg')); ?>" width="1086" height="1448" alt="星空を背景にしたLumièreメンバー3人の写真"></div><div class="inner-hero-copy"><p class="breadcrumb"><a href="<?php echo esc_url(home_url('/')); ?>">HOME</a> / NEWS</p><p class="kicker">LIVE INFO / IMPORTANT NEWS</p><h1>次に会える場所と、<br>大切なお知らせ。</h1><p>出演予定、活動に関するご案内、協会からの重要なお知らせをまとめています。</p></div><span class="inner-hero-number">03</span></section>
