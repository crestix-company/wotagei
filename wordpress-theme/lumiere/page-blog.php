...
$daily_photos = array(
    array('image' => 'diary-01.jpg', 'alt' => '夜のイベントを終えたLumièreメンバーと来場者', 'label' => '出演後のひととき', 'layout' => 'portrait'),
    array('image' => 'diary-02.jpg', 'alt' => '撮影現場で記念写真に収まるLumièreと来場者', 'label' => '撮影の舞台裏', 'layout' => 'portrait'),
    array('image' => 'diary-03.jpg', 'alt' => 'イベント会場で交流するLumièreメンバー', 'label' => '地域とのつながり', 'layout' => 'portrait'),
    array('image' => 'diary-04.jpg', 'alt' => '海辺の会場でポーズをとるLumièreメンバー', 'label' => '仲間との時間', 'layout' => 'feature'),
    array('image' => 'diary-05.jpg', 'alt' => '交流会で記念写真に収まるLumièreメンバーと関係者', 'label' => '特別なひととき', 'layout' => 'landscape'),
    array('image' => 'diary-06.jpg', 'alt' => '海外ゲストと交流するLumièreメンバー', 'label' => '新しい出会い', 'layout' => 'landscape'),
    array('image' => 'diary-07.jpg', 'alt' => '地域のキャラクターとポーズをとるLumièreメンバー', 'label' => 'お祭りの夜', 'layout' => 'square'),
    array('image' => 'diary-08.jpg', 'alt' => '活動を支える仲間と笑顔で過ごすLumièreメンバー', 'label' => 'ステージの外で', 'layout' => 'square'),
    array('image' => 'diary-09.jpg', 'alt' => 'テレビで紹介されたLumièreのヲタ芸パフォーマンス', 'label' => 'テレビ出演', 'layout' => 'square'),
    array('image' => 'diary-10.jpg', 'alt' => 'イベントで披露されたLumièreのヲタ芸', 'label' => 'ヲタ芸文化', 'layout' => 'panorama'),
    array('image' => 'diary-11.jpg', 'alt' => '地域イベントで来場者と記念写真に収まるLumièreメンバー', 'label' => '地域での日々', 'layout' => 'portrait'),
    array('image' => 'diary-12.jpg', 'alt' => '講習会で参加者と交流するLumièreメンバー', 'label' => '講習会', 'layout' => 'end'),
    array('image' => 'diary-13.jpg', 'alt' => '講習後に参加者と笑顔で記念撮影するLumièreメンバー', 'label' => '新しいつながり', 'layout' => 'end'),
);
?>
<main id="top">
