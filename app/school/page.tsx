...
export default function SchoolPage() {
  return <main id="top"><SiteHeader />
    <section className="inner-hero school-hero"><div className="inner-hero-bg"><img src="/assets/member-subaru.jpg" alt="Lumièreのスクール講師" /></div><div className="inner-hero-copy"><p className="breadcrumb"><a href="/">HOME</a> / SCHOOL</p><p className="kicker">WLD SCHOOL</p><h1>光を持つと、<br />体が動き出す。</h1><p>いすみ市で通える対面レッスンと、学校・団体への講師派遣をご案内します。</p></div><span className="inner-hero-number">06</span></section>
