...
export default function ServicesPage() {
  return (
    <main id="top">
      <SiteHeader />
      <section className="inner-hero inner-service services-hero"><div className="inner-hero-bg"><img src="/assets/services-hero-bon-odori.jpg" alt="提灯に囲まれた盆踊り会場でのヲタ芸パフォーマンス" /></div><div className="inner-hero-copy"><p className="breadcrumb"><a href="/">HOME</a> / SERVICE</p><p className="kicker">PERFORMANCE REQUEST</p><h1>光と熱狂を、<br />あなたの場所へ。</h1><p>企業イベント、地域のお祭り、学校行事、映像作品まで。</p></div><span className="inner-hero-number">05</span></section>
