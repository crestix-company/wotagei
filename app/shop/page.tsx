...
export default function ShopPage() {
  return <main id="top"><SiteHeader />
    ...
    <section className="shop-coming"><p className="kicker">ONLINE STORE</p><span>COMING SOON</span><h2>ただいま、<br />開店準備中です。</h2><p>オリジナルTシャツ、パンツ、その他グッズを順次公開予定です。最新情報はSNSでお知らせします。</p><div className="shop-items"><article><b>T-SHIRT</b><small>ORIGINAL WEAR</small></article><article><b>PANTS</b><small>PERFORMANCE WEAR</small></article><article><b>GOODS</b><small>LIGHT &amp; ACCESSORIES</small></article></div><a className="button button-primary" href="https://www.instagram.com/lumiere20241103" target="_blank" rel="noreferrer">最新情報を見る <i>↗</i></a></section>
