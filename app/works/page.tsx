...
export default function WorksPage() {
  return (
    <main id="top">
      <SiteHeader />
      <section className="inner-hero inner-works"><div className="inner-hero-bg"><picture><source media="(max-width: 720px)" srcSet="/assets/works-hero-duo-mobile.jpg" /><img src="/assets/works-hero-duo.jpg" alt="Lumièreメンバーのオフショット" /></picture></div><div className="inner-hero-copy"><p className="breadcrumb"><a href="/">HOME</a> / WORKS</p><p className="kicker">ACHIEVEMENTS</p><h1>挑戦の数だけ、<br />光は強くなる。</h1><p>千葉の地域イベントから、ハワイのステージ、映画、メディアへ。</p></div><span className="inner-hero-number">04</span></section>
